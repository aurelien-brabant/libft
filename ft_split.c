...
/*   Updated: 2020/10/14 17:20:02 by abrabant         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
**
** @return (number of words + 1), including NULL termination for the string
...
**
** @return	a string array that contains every word + ending NULL pointer.
*/
